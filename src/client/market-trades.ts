...
@Component({
  ...
  template: `<ag-grid-angular #marketList (click)="this.loadSubscriber()" class="ag-K {{ subscribed ? \'ag-subscribed\' : \'ag-not-subscribed\' }} marketTrades" rowHeight="18" [gridOptions]="gridOptions"></ag-grid-angular>`
})
